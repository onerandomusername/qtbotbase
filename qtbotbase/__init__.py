...
####################
# NOTE: do not import any other modules from qtbotbase before the `log.setup()` call
####################
from qtbotbase import log


log.setup()


from qtbotbase import monkey_patches  # noqa: E402  # we need to set up logging before importing anything else
