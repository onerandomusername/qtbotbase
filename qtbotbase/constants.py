...
if TYPE_CHECKING:
    from qtbotbase.log import CustomLogger
...
class Client:
    name = "Qt Core"
    git_repo = "https://github.com/onerandomusername/qtbotbase"
    ...
    # But qtbotbase fetches the ones configured in the developer portal and replace these
...
class Database:
    postgres_bind: str = environ.get("DB_BIND", "sqlite+aiosqlite:///./qtbotbase.db")
