...
from qtbotbase import exts
from qtbotbase.bot import QtBotBase
from qtbotbase.constants import Client
from qtbotbase.log import get_logger
from qtbotbase.metadata import ExtMetadata
from qtbotbase.utils import scheduling
from qtbotbase.utils.converters import Extension
from qtbotbase.utils.extensions import EXTENSIONS, invoke_help_command
from qtbotbase.utils.messages import DeleteButton
from qtbotbase.utils.pagination import LinePaginator
...
class Action(Enum):
    ...
    LOAD = functools.partial(QtBotBase.load_extension)
    UNLOAD = functools.partial(QtBotBase.unload_extension)
    RELOAD = functools.partial(QtBotBase.reload_extension)


class Extensions(commands.Cog):
    """Extension management commands."""

    def __init__(self, bot: QtBotBase) -> None:
        self.bot = bot
