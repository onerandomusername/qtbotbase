...
from qtbotbase.constants import Colours, Monitoring
from qtbotbase.errors import APIError, QtBotBaseCommandError
from qtbotbase.log import get_logger
from qtbotbase.metadata import ExtMetadata
from qtbotbase.utils import responses
...
class ErrorHandler(
    ...
    async def on_command_error(self, ctx: AnyContext, error: commands.CommandError) -> None:
        ...
        elif isinstance(error, QtBotBaseCommandError):
