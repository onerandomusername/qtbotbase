...
from qtbotbase.constants import Client, Colours
from qtbotbase.utils.helpers import utcnow
...
PRIVACY = """
Like every piece of software out there, qtbotbase has a privacy policy.
...
class Meta(
    ...
    @commands.slash_command(name="qtbotbase")
    async def qtbotbase(self, inter: disnake.CommandInteraction) -> None:
        """Meta commands."""
        pass

    @qtbotbase.sub_command()
    ...
    @qtbotbase.sub_command(name="status")
