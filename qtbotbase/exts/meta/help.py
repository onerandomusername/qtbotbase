...
from qtbotbase import constants
from qtbotbase.bot import QtBotBase
from qtbotbase.constants import Emojis
from qtbotbase.log import get_logger
from qtbotbase.metadata import ExtMetadata
from qtbotbase.utils import scheduling
from qtbotbase.utils.pagination import FIRST_EMOJI, LAST_EMOJI, LEFT_EMOJI, RIGHT_EMOJI, LinePaginator
...
def teardown(bot: QtBotBase) -> None:
    """
