...
import qtbotbase.alembic
from qtbotbase import constants, monkey_patches
...
async def run_async_upgrade(engine: AsyncEngine) -> None:
    ...
    alembic_cfg.set_main_option("script_location", os.path.dirname(qtbotbase.alembic.__file__))
